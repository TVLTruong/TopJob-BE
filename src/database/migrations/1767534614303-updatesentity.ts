...
export class Updatesentity1767534614303 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "employer_categories" ("id" BIGSERIAL NOT NULL, "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_26d56e0ef152a4df7d9bbefdb2f" UNIQUE ("slug"), CONSTRAINT "PK_7c662384983f629685c838eca0d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_26d56e0ef152a4df7d9bbefdb2" ON "employer_categories" ("slug") `,
    );
    await queryRunner.query(
      `CREATE TABLE "employer_employer_categories" ("id" BIGSERIAL NOT NULL, "employer_id" bigint NOT NULL, "category_id" bigint NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0e87ab6a3603e51ad86763b0b61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c34dd9ec83bf9b7131468373e8" ON "employer_employer_categories" ("employer_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6e84b23bcb231e15df4505bf12" ON "employer_employer_categories" ("category_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_32a021c87969f4f6a16ff201af" ON "employer_employer_categories" ("employer_id", "category_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employers_status_enum" AS ENUM('pending_approval', 'active', 'banned')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."employers_profile_status_enum" AS ENUM('approved', 'pending_edit_approval', 'pending_new_approval')`,
    );
    await queryRunner.query(
      `CREATE TABLE "employers" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "full_name" character varying(255) NOT NULL, "work_title" character varying(255) NOT NULL, "company_name" character varying(255) NOT NULL, "description" text, "website" text, "logo_url" text, "founded_date" TIMESTAMP, "contact_email" character varying(255), "contact_phone" character varying(20), "linkedlnUrl" text, "facebookUrl" text, "xUrl" text, "is_approved" boolean NOT NULL DEFAULT false, "status" "public"."employers_status_enum" NOT NULL DEFAULT 'pending_approval', "profile_status" "public"."employers_profile_status_enum" NOT NULL DEFAULT 'approved', "benefits" text array, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b5db2de89197ada09695cbaf900" UNIQUE ("user_id"), CONSTRAINT "REL_b5db2de89197ada09695cbaf90" UNIQUE ("user_id"), CONSTRAINT "PK_f2c1aea3e8d7aa3c5fba949c97d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "job_job_categories" ("id" BIGSERIAL NOT NULL, "job_id" bigint NOT NULL, "category_id" bigint NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f80cb3d67f2b18ccb39beb73ea5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b045953a48d543f9a84dd3b493" ON "job_job_categories" ("job_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_daeb09303776efca8643f5fd23" ON "job_job_categories" ("category_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_34954d8e3ad9b58a34834b8ee9" ON "job_job_categories" ("job_id", "category_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."jobs_employmenttype_enum" AS ENUM('full_time', 'part_time', 'freelance', 'internship', 'contract')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."jobs_workmode_enum" AS ENUM('onsite', 'remote', 'hybrid')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."jobs_experiencelevel_enum" AS ENUM('intern', 'fresher', 'junior', 'middle', 'senior', 'lead', 'manager')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."jobs_status_enum" AS ENUM('draft', 'pending_approval', 'active', 'expired', 'closed', 'hidden', 'rejected', 'removed_by_admin', 'removed_by_employer')`,
    );
    await queryRunner.query(
      `CREATE TABLE "jobs" ("id" BIGSERIAL NOT NULL, "employer_id" bigint NOT NULL, "location_id" bigint NOT NULL, "title" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" text, "responsibilities" text array, "requirements" text array, "nice_to_have" text array, "benefits" text array, "employmentType" "public"."jobs_employmenttype_enum" NOT NULL, "workMode" "public"."jobs_workmode_enum" NOT NULL, "quantity" integer NOT NULL DEFAULT '1', "experienceYearsMin" integer, "experienceLevel" "public"."jobs_experiencelevel_enum", "salaryMin" numeric(12,2), "salaryMax" numeric(12,2), "isNegotiable" boolean NOT NULL DEFAULT false, "isSalaryVisible" boolean NOT NULL DEFAULT true, "salaryCurrency" character varying(10) NOT NULL DEFAULT 'VND', "status" "public"."jobs_status_enum" NOT NULL DEFAULT 'draft', "expired_at" TIMESTAMP, "published_at" TIMESTAMP, "viewCount" integer NOT NULL DEFAULT '0', "applyCount" integer NOT NULL DEFAULT '0', "saveCount" integer NOT NULL DEFAULT '0', "is_hot" boolean NOT NULL DEFAULT false, "is_urgent" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_ebf78eba11615c490d5db84451a" UNIQUE ("slug"), CONSTRAINT "PK_cf0a6c42b72fcc7f7c237def345" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_13ffcd5ea43723305d77d387b1" ON "jobs" ("expired_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "job_technologies" ("id" BIGSERIAL NOT NULL, "job_id" bigint NOT NULL, "technology_id" bigint NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a6fe8844fc295ea0d4ba5c8438d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b59f92cffd76523e7b1241cee4" ON "job_technologies" ("technology_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b70dcfab63db073f494cb5689c" ON "job_technologies" ("job_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_05de31a0c83d0275cb247f5c02" ON "job_technologies" ("job_id", "technology_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "employer_employer_categories" ADD CONSTRAINT "FK_c34dd9ec83bf9b7131468373e86" FOREIGN KEY ("employer_id") REFERENCES "employers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "employer_employer_categories" ADD CONSTRAINT "FK_6e84b23bcb231e15df4505bf127" FOREIGN KEY ("category_id") REFERENCES "employer_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_job_categories" ADD CONSTRAINT "FK_b045953a48d543f9a84dd3b4935" FOREIGN KEY ("job_id") REFERENCES "jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_job_categories" ADD CONSTRAINT "FK_daeb09303776efca8643f5fd23e" FOREIGN KEY ("category_id") REFERENCES "jobs_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "jobs" ADD CONSTRAINT "FK_c5aba92c72d96d22a75ed1f9622" FOREIGN KEY ("employer_id") REFERENCES "employers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_technologies" ADD CONSTRAINT "FK_b70dcfab63db073f494cb5689c6" FOREIGN KEY ("job_id") REFERENCES "jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_technologies" ADD CONSTRAINT "FK_b59f92cffd76523e7b1241cee48" FOREIGN KEY ("technology_id") REFERENCES "technologies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "job_technologies" DROP CONSTRAINT "FK_b59f92cffd76523e7b1241cee48"`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_technologies" DROP CONSTRAINT "FK_b70dcfab63db073f494cb5689c6"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_job_categories" DROP CONSTRAINT "FK_daeb09303776efca8643f5fd23e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_job_categories" DROP CONSTRAINT "FK_b045953a48d543f9a84dd3b4935"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "employer_employer_categories" DROP CONSTRAINT "FK_6e84b23bcb231e15df4505bf127"`,
    );
    await queryRunner.query(
      `ALTER TABLE "employer_employer_categories" DROP CONSTRAINT "FK_c34dd9ec83bf9b7131468373e86"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_05de31a0c83d0275cb247f5c02"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b70dcfab63db073f494cb5689c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b59f92cffd76523e7b1241cee4"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_13ffcd5ea43723305d77d387b1"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_34954d8e3ad9b58a34834b8ee9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_daeb09303776efca8643f5fd23"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b045953a48d543f9a84dd3b493"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_32a021c87969f4f6a16ff201af"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6e84b23bcb231e15df4505bf12"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c34dd9ec83bf9b7131468373e8"`,
    );
    await queryRunner.query(`DROP TABLE "employer_employer_categories"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_26d56e0ef152a4df7d9bbefdb2"`,
    );
